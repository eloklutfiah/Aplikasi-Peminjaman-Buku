        ...
        <div class="row">
            <div class="col-lg">
              <div class="p-5">
                ...
                <hr>
                <div class="text-center"> <a class="small" href="<?= base_url('authentifikasi/lupaPassword'); ?>">Lupa Password?</a> </div>
                <div class="text-center"> <a class="small" href="<?= base_url('authentifikasi/registrasi'); ?>">Daftar Member!</a> </div>
              </div>
            </div>
          </div>
        </div>
